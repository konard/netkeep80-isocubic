...
Подробный план развития проекта находится в **[ROADMAP.md](ROADMAP.md)**.
...
|------|----------|--------|
| 1 | MVP | ✅ Завершена |
| 2 | FFT для магических объектов | ✅ Завершена |
| 3 | Оптимизация | ✅ Завершена |
| 4 | Мультиплеер и коллаборация | ✅ Завершена |
| 5 | Расширение редактора | 🔄 В процессе |
| 6 | Публикация и шаринг | 📋 Планируется |

> Детальное описание задач каждой фазы: [docs/phases/](docs/phases/)
