...
|------|----------|--------|
| 1 | [MVP](docs/phases/phase-1-mvp.md) | ✅ Завершена |
| 2 | [FFT для магических объектов](docs/phases/phase-2-fft.md) | ✅ Завершена |
| 3 | [Оптимизация](docs/phases/phase-3-optimization.md) | ✅ Завершена |
| 4 | [Мультиплеер](docs/phases/phase-4-multiplayer.md) | ✅ Завершена |
| 5 | [Расширение редактора](docs/phases/phase-5-editor.md) | 🔄 В процессе |
| 6 | [Публикация и шаринг](docs/phases/phase-6-sharing.md) | 🔄 В процессе |
